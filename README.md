...
│   │   ├── App.css             # Stylesheet of the main app.
│   │   ├── App.js              # Main app entry after index.
│   │   ├── App.test            # 
...
│   ├── starshipController.js   # Handle starship requests.
├── models                      # The Mongoose models of our Mongo database.
│   ├── starship.js             # Schema of the starship.
├── routes                      # Routing for the Express server.
│   ├── index.js                # 
│   ├── users.js                # 
│   ├── inventory.js            # Main routes
├── views                       # The views which will be replaced with React in client subdirectory.
├── .gitignore                  # Files to not include when pushing with git.
